...
function active_categories(id) {
    $.ajax({
        url: './active_categories',
        type: 'GET',
        // dataType: 'html',
        data: {
            id: id
...
function active_administration(id) {
    $.ajax({
        url: './active_administration',
        type: 'GET',
        data: {
            id: id
        }

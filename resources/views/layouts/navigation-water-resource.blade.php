...
<ul class="navbar-nav justify-content-between w-100">
    ...
    <li class="wr-navigation-item nav-item font-weight-bold dropdown position-relative">
	    ...
	    <ul class="dropdown-menu p-0 sub-menu rounded-0 border-0">
            <li class="dropdown-item"><a href="#">Hồ chứa thủy điện trên 2MW </a></li>
            <li class="dropdown-item"><a href="#">Hồ chứa thủy điện dưới 2MW </a></li>
            <li class="dropdown-item"><a href="#">Hồ chứa khai thác nước mặt sản xuất nông nghiệp </a></li>
            <li class="dropdown-item"><a href="#">Trạm bơm </a></li>
            <li class="dropdown-item"><a href="#">Công trình khai thác, sử dụng nước dưới đất </a></li>
	    </ul>
	</li>
    <li class="wr-navigation-item nav-item font-weight-bold position-relative">
        ...
        <ul class="dropdown-menu p-0 sub-menu rounded-0 border-0">
            <li class="dropdown-item"><a href="#">QLCP khai thác sử dụng nước mặt </a></li>
            <li class="dropdown-item"><a href="#">QLCP khai thác sử dụng nước dưới đất </a></li>
        </ul>
    </li>
	<li class="wr-navigation-item nav-item font-weight-bold position-relative">
        <a href="#" class="nav-link px-2 py-0  dropdown-toggle">THÔNG TIN DỮ LIỆU</a>
        <ul class="dropdown-menu p-0 sub-menu rounded-0 border-0">
            <li class="dropdown-item"><a href="#">Tiểu vùng TNN </a></li>
            <li class="dropdown-item"><a href="#">Số lượng, chất lượng nước mặt, nước dưới đất </a></li>
            <li class="dropdown-item"><a href="#">Số liệu điều tra khảo sát địa chất thủy văn </a></li>
            <li class="dropdown-item"><a href="#">Kết quả cấp, gia hạn, thu hồi, điều chỉnh giấy phép </a></li>
        </ul>
    </li>
    <li class="wr-navigation-item nav-item font-weight-bold position-relative">
        <a href="#" class="nav-link px-2 py-0  dropdown-toggle">THÔNG BÁO</a>
        <ul class="dropdown-menu p-0 sub-menu rounded-0 border-0">
            <li class="dropdown-item"><a href="#">Tổ chức/ cá nhân </a></li>
            <li class="dropdown-item"><a href="#">Cơ quan nhà nước  </a></li>
        </ul>
    </li>

        ...
        <table class="list-station w-100 mt-3">
            <thead>
                <tr class="row-station text-center text-white">
                    ...
                    <th class="item py-2">Độ cao tương đối</th>
            ...
            <tbody>
                <tr class="text-center">
                    ...
                    <td class="item py-2">Mã trạm</td>
                    <td class="item py-2">Loại trạm</td>
                    <td class="item py-2">107o11'03"</td>
                    <td class="item py-2">11o44'</td>
                    <td class="item py-2">Độ cao tương đối</td>
                    <td class="item py-2">Độ cao tuyệt đối</td>
